...
public class GigFinder extends javax.swing.JFrame {
    Job[] job;
    ArrayList<Integer> on_campus_index = new ArrayList<Integer>();
    ArrayList<Integer> food_service_index = new ArrayList<Integer>();
    ArrayList<Integer> tutor_index = new ArrayList<Integer>();
    int[] date_index;
